...
def get_args():
    ...
    parser.add_argument(
        ...
        default=9,
        type=int,
        help='early_layers, default 9 for base and 21 for large')
    parser.add_argument(
        '--head_layers', default=2, type=int, help='head_layers')
    parser.add_argument(
        '--shared_lm_head',
        default=True,
    ...
    parser.add_argument(
        '--codebook_size', default=8192, type=int, help='number of codebook')
    parser.add_argument(
        '--codebook_dim', default=32, type=int, help='number of codebook')
    ...
    parser.add_argument(
        ...
        default='lanczos',
        help=
        'Interpolation for discrete vae (random, bilinear, bicubic default: "bicubic")'
    )
    parser.add_argument(
        '--min_crop_scale',
        type=float,
    ...
    parser.add_argument(
        ...
        help='dataset path')
    parser.add_argument(
        '--eval_data_path', default='', type=str, help='dataset path')
    parser.add_argument(
        '--data_set', default='image_folder', type=str, help='dataset path')
...
def main(args):
    ...
    # torch.save(model.state_dict(), '../../../models/beit_ckpt/beit-base.pth')
    checkpoint = torch.load('../../../models/beit_ckpt/beit-base.pth')
